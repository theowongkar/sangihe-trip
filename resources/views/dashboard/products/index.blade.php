        ...
        <div class="bg-gray-50 rounded-lg border border-gray-300 shadow">
            <div class="p-2 space-y-2">
                ...
                <div x-data="{ openCreate: false }" class="flex flex-col lg:flex-row items-center justify-between gap-4">
                    {{-- Tombol Tambah --}}
                    <x-buttons.primary-button href="{{ route('dashboard.product.create') }}"
            ...
            <table class="min-w-full text-sm">
                <thead class="bg-[#115e6d] text-gray-50">
                    <tr>
                        ...
                        <th class="p-2 font-normal text-left border-r border-gray-600">Nama Usaha</th>
                        <th class="p-2 font-normal text-left border-r border-gray-600">Nama Pemilik</th>
                        <th class="p-2 font-normal text-left border-r border-gray-600">No. Telepon</th>
                ...
                <tbody class="divide-y divide-gray-300">
                    @forelse($products as $product)
                        <tr class="hover:bg-blue-50">
                            ...
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $product->owner_name }}
                            </td>
                            <td class="p-2 border-r border-gray-300 whitespace-nowrap">{{ $product->owner_phone }}
                            </td>
                            <td class="p-2 border-r border-gray-300">{{ $product->address }}
                            </td>
                            <td class="p-2 text-center border-r border-gray-300">
                                @php
